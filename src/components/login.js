...
export default function Login() {
    ...
    return (
        <>
            <div className={"w-1/5 h-2/5 bg-discordGrey-std rounded-lg shadow-xl z-50 absolute flex flex-col"}>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className={"flex flex-col gap-6"}>
                    ...
                    <button className={" mt-4 mx-4 rounded-lg p-4 bg-discordGrey-dark text-slate-300 font-bold transition hover:bg-slate-300 hover:text-discordGrey-darker"}>Log In</button>
                </form>
            </div>
        </>
    )
