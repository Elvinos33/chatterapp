...
export default function Loginpage() {
    ...
    return (
        <>
            ...
            <main className={"absolute inset-0 bg-discordGrey-dark flex flex-col justify-center items-center gap-3"}>
                <div>
                    <Image alt={"Image of Messaging"} src={"/frontSvg.svg"} width={500} height={345}/>
                </div>
                <div>
                    <h1 className={"font-bold text-[3rem] text-slate-300"}>Welcome.</h1>
                </div>
                <div onClick={handleBackClick} className={"absolute h-full w-full"}></div>
